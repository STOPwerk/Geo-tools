...
python.exe -m pip install geopandas
...
python.exe %~dp0geo-tools\applicatie.py --meldingen %~dp0logs --alle %1 %2 %3 %4 %5 %6 %7 %8 %9
goto Check_Error
:MijnVoorbeelden
python.exe %~dp0geo-tools\applicatie.py --meldingen %~dp0logs --alle "mijn voorbeelden"
