...
<geo:GeoInformatieObjectVersie schemaversie="1.3.0"
	...
	<geo:FRBRExpression>/join/id/regdata/mnre9999/2022/uitleg4/nld@2022;4</geo:FRBRExpression>
	<geo:groepen>
		<geo:Groep>
			<geo:groepID>G1</geo:groepID>
			<geo:label>Park</geo:label>
		</geo:Groep>
		<geo:Groep>
			<geo:groepID>G2</geo:groepID>
			<geo:label>Sportvelden</geo:label>
		</geo:Groep>
		<geo:Groep>
			<geo:groepID>G5</geo:groepID>
			<geo:label>Zelfoogsttuinen</geo:label>
		</geo:Groep>
		<geo:Groep>
			<geo:groepID>G4</geo:groepID>
			<geo:label>Kinologie</geo:label>
		</geo:Groep>
	</geo:groepen>
	<geo:locaties>
		<geo:Locatie>
