...
#======================================================================
    ...
    def _BepaalWijzigingen (self) :
        ...
        self.Generator.VoegHtmlToe ('''<p>Voor de bepaling van een GIO-wijziging wordt de elders beschreven <a href="https://github.com/STOPwerk/Geo-tools/wiki/Maak-gio-wijziging" target="_blank">procedure</a> gevolgd.
