...
#region Maken van een webpagina
    ...
    def VoerUit(self):
        ...
        self.Log.Informatie ("Geo-tools (https://github.com/STOPwerk/Geo-tools/) versie 2023-01-27 12:35:17.")
        try:
...
#region Maken van GML
    ...
    def SchrijfGIO (self, gio : GeoData) -> str:
        ...
        gio GeoData  Het GIO
        """
        gioGML = '''<geo:GeoInformatieObjectVersie schemaversie="2.0.0-rc" xmlns:basisgeo="http://www.geostandaarden.nl/basisgeometrie/1.0" xmlns:geo="https://standaarden.overheid.nl/stop/imop/geo/" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="https://standaarden.overheid.nl/stop/imop/geo/
