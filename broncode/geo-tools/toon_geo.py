...
#======================================================================
    ...
    def _VoerUit (self):
        ...
        if self._Geometrie.Soort == 'GIO' and not self.NauwkeurigheidInDecimeter (False) is None:
            ...
            self.Generator.VoegHtmlToe ('''<p>Het opgeven van een teken-nauwkeurigheid voor een GIO suggereert dat twee <a href="https://koop.gitlab.io/STOP/voorinzage/standaard-preview-b/geo_xsd_Element_geo_Locatie.html" target="_blank">GIO-Locaties</a>
            elkaar niet overlappen binnen de teken-nauwkeurigheid. Om te zien of dat klopt wordt de elders beschreven <a href="https://github.com/STOPwerk/Geo-tools/wiki/Toon-controleer-gio" target="_blank">procedure</a> gevolgd.</p>''')
